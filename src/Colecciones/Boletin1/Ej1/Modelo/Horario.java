...
public class Horario {
    ...
    private String[][] modulos = new String[5][6]; //5 días de clase y 6 horas para cada día (que ruina....)
    ...
    public void asignarModulo(int dia, int hora, String modulo) {
        modulos[dia][hora] = modulo; //he entendido esto HOY ("en qué posición quieres añadir módulo?? en la 0,1")
    }
